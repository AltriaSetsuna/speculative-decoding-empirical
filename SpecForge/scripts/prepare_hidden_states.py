...
def parse_args():
    ...
    data_group.add_argument("--build-dataset-num-proc", type=int, default=64)
...
def build_target_model(
    ...
    if args.is_vlm and model_config.model_type == "qwen2_5_vl" and args.tp_size == 1:
        ...
        target_model_kwargs["mem_fraction_static"] = 0.8  
        target_model_kwargs["max_running_requests"] = 4 
        target_model_kwargs["context_length"] = 15000
        # target_model_kwargs["max_total_tokens"] = 40000
